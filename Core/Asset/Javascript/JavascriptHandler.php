...
class JavascriptHandler extends AbstractAssetHandler
{
     ...
     */
    public function &createFile($url, $defer = true, $combine = true, $minify = true): JavascriptObjectInterface
    {
     ...
     * @return JavascriptObjectInterface
     */
    public function &createReady($content, $defer = true, $combine = true, $minify = true): JavascriptObjectInterface
    {
        $obj = new JavascriptObject();
     ...
     * @return JavascriptObjectInterface
     */
    public function &createVariable($name, $value, $is_string = false, $defer = false, $combine = true, $minify = true): JavascriptObjectInterface
    {
        if ($is_string == true) {
            $value = '"' . $value . '"';
        }
